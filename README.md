...
curl -fsSL https://github.com/Praeviso/AgentSSH/releases/download/v0.11.0/agentssh_v0.11.0_linux_amd64.tar.gz \
  | sudo tar xz --strip-components=1 -C /usr/local/bin agentssh_v0.11.0_linux_amd64/agentssh
...
# Linux arm64
curl -fsSL https://github.com/Praeviso/AgentSSH/releases/download/v0.11.0/agentssh_v0.11.0_linux_arm64.tar.gz \
  | sudo tar xz --strip-components=1 -C /usr/local/bin agentssh_v0.11.0_linux_arm64/agentssh

# macOS Apple Silicon (arm64)
curl -fsSL https://github.com/Praeviso/AgentSSH/releases/download/v0.11.0/agentssh_v0.11.0_darwin_arm64.tar.gz \
  | sudo tar xz --strip-components=1 -C /usr/local/bin agentssh_v0.11.0_darwin_arm64/agentssh

# macOS Intel (amd64)
curl -fsSL https://github.com/Praeviso/AgentSSH/releases/download/v0.11.0/agentssh_v0.11.0_darwin_amd64.tar.gz \
  | sudo tar xz --strip-components=1 -C /usr/local/bin agentssh_v0.11.0_darwin_amd64/agentssh
```

Verify: `agentssh --version`. (Bump `v0.11.0` for a different release; checksums are in `SHA256SUMS.txt` on the Releases page.)
